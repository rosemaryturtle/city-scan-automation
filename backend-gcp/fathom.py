...
def calculate_flood_osm_stats(cloud_bucket, output_dir, local_output_dir, city_name_l, poi, flood_raster):
    ...
    utils.download_blob_timed(cloud_bucket, f"{output_dir}/spatial/{city_name_l}_osm_{poi}.gpkg", f'{local_output_dir}/{city_name_l}_osm_{poi}.gpkg', 180*60, 60)
...
# TODO: major roads exposure calculations
