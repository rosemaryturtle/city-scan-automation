...
ojs_define(createdMaps = c("population", "rwi", "economic_activity", "economic_change", "wsf", "land_cover", "intersections", "school_zones", "school_points", "health_zones", "health_points", "solar", "air_quality", "summer_lst", "vegetation", "forest", "deforest", "infrastructure", "elevation", "slope", "landslides", "liquefaction", "burnable", "burnt_area", "fluvial", "pluvial", "coastal", "combined_flooding"))
```
