...
#| include: false
#| label: prerender
city <- "Guiyang" # For some reason source isn't enough for adding city name to title
country <- "China"
source('R/maps.R')
```
...
<div id="cover-map">
![](mnt/2024-08-china-guiyang/02-process-output/spatial/guiyang_network_plus_building_footprints-small-dither.png)
</div>
